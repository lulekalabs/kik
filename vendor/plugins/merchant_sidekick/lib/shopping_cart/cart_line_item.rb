...
#
# CartLineItem is a copy of the actual product upon putting a product into a cart.
# This class copies many of the product attributes, because Product rows may undergo
# constant changes (description, price), while the cart_line_item will remain unchanged
# during its lifetime.
