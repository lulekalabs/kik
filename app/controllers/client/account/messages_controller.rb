# Client "Rechtssuchender" Messages
class Client::Account::MessagesController < Client::Account::ClientAccountApplicationController
  ...
  def show
    ...
    respond_to do |format|
      format.html { render :template => "client/account/messages/show" }
      format.js { render :nothing => true }
    end
  end

  def unread
    render :template => "client/account/messages/index"
  end
