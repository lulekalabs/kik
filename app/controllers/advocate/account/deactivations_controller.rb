class Advocate::Account::DeactivationsController < Advocate::Account::AdvocateAccountApplicationController
  ...
  def create
    ...
    render :template => "advocate/account/deactivations/show"
  end
